...
public class DataHotel {
	...
	public CommandLineRunner initDatabase(ChambreRepository repositoryC, ClientRepository repositoryCl, HotelRepository repositoryH, PartenaireRepository repositoryP, ReservationRepository repositoryR, AgenceRepository repositoryAg){
		return args -> {
			...
			//Hôtel
			Hotel h1 = new Hotel(3, "Le palace", "Paris", 3);
			repositoryH.save(h1);
			...
			//Chambres
			Chambre ch1 = new Chambre(1, 70, 2, 3);
			Chambre ch2 = new Chambre(2, 80, 2, 3);
			Chambre ch3 = new Chambre(3, 90, 2, 3);
			Chambre ch4 = new Chambre(4, 100, 4, 3);
			Chambre ch5 = new Chambre(5, 110, 2, 3);
			Chambre ch6 = new Chambre(6, 120, 4, 3);
			Chambre ch7 = new Chambre(7, 130, 4, 3);
			Chambre ch8 = new Chambre(8, 140, 3, 3);
			Chambre ch9 = new Chambre(9, 150, 2, 3);
			Chambre ch10 = new Chambre(10, 200, 6, 3);
			...
			//Partenaires
			Partenaire p2 = new Partenaire(10, 2, "agence2", 3);
			repositoryP.save(p2);
			Partenaire p3 = new Partenaire(30, 3, "agence3", 3);
			repositoryP.save(p3);
