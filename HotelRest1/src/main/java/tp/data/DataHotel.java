...
public class DataHotel {
	...
	public CommandLineRunner initDatabase(ChambreRepository repositoryC, ClientRepository repositoryCl, HotelRepository repositoryH, PartenaireRepository repositoryP, ReservationRepository repositoryR, AgenceRepository repositoryAg){
		return args -> {
			...
			//Hôtel
			Hotel h1 = new Hotel(0, "Le plaza", "Paris", 3);
			repositoryH.save(h1);
			...
			//Chambres
			Chambre ch1 = new Chambre(1, 70, 2, 0);
			Chambre ch2 = new Chambre(2, 80, 2, 0);
			Chambre ch3 = new Chambre(3, 90, 2, 0);
			Chambre ch4 = new Chambre(4, 100, 4, 0);
			Chambre ch5 = new Chambre(5, 110, 2, 0);
			Chambre ch6 = new Chambre(6, 120, 4, 0);
			Chambre ch7 = new Chambre(7, 130, 4, 0);
			Chambre ch8 = new Chambre(8, 140, 3, 0);
			Chambre ch9 = new Chambre(9, 150, 2, 0);
			Chambre ch10 = new Chambre(10, 200, 6, 0);
			...
			//Partenaires
			Partenaire p1 = new Partenaire(10, 1, "agence1", 0);
			repositoryP.save(p1);
			Partenaire p2 = new Partenaire(5, 2, "agence2", 0);
			repositoryP.save(p2);
			Partenaire p3 = new Partenaire(15, 3, "agence3", 0);
			repositoryP.save(p3);
