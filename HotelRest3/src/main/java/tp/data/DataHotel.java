...
public class DataHotel {
	...
	public CommandLineRunner initDatabase(ChambreRepository repositoryC, ClientRepository repositoryCl, HotelRepository repositoryH, PartenaireRepository repositoryP, ReservationRepository repositoryR, AgenceRepository repositoryAg){
		return args -> {
			...
			//Hôtel
			Hotel h1 = new Hotel(2, "Le plaza 3", "Paris", 3);
			repositoryH.save(h1);
			...
			//Chambres
			Chambre ch1 = new Chambre(1, 70, 2, 2);
			Chambre ch2 = new Chambre(2, 80, 2, 2);
			Chambre ch3 = new Chambre(3, 90, 2, 2);
			Chambre ch4 = new Chambre(4, 100, 4, 2);
			Chambre ch5 = new Chambre(5, 110, 2, 2);
			Chambre ch6 = new Chambre(6, 120, 4, 2);
			Chambre ch7 = new Chambre(7, 130, 4, 2);
			Chambre ch8 = new Chambre(8, 140, 3, 2);
			Chambre ch9 = new Chambre(9, 150, 2, 2);
			Chambre ch10 = new Chambre(10, 200, 6, 2);
			...
			//Partenaires
			Partenaire p1 = new Partenaire(15, 1, "agence1", 2);
			repositoryP.save(p1);
			Partenaire p2 = new Partenaire(20, 2, "agence2", 2);
			repositoryP.save(p2);
